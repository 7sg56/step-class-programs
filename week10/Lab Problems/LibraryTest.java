...
class Librarian {
    ...
    public void manageBook(Book book) {
        System.out.println("Librarian " + empId + " (" + shift + ") is managing: " + book.getDetails());
    }
    
    public void issueCard(Member member) {
        System.out.println("Librarian " + empId + " issued library card to: " + member.toString());
    }
}

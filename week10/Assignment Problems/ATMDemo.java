...
class BankAccount {
    ...
    public void showDetails() { System.out.println("Account: " + accNumber + ", Balance: $" + String.format("%.2f", balance)); }
}
...
class Customer {
    ...
    public Customer(String name, ATM atm) { this.name = name; this.atm = atm; }

    public void performWithdrawal(int pin, double amount) {
        System.out.println("\n--- " + name + " is requesting withdrawal of $" + String.format("%.2f", amount) + " ---");
